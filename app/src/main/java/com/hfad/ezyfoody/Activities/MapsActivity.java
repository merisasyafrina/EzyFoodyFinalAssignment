...
import com.hfad.ezyfoody.DirectionsJSONParser;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public static final String ADDRESS = "com.example.ezyfoody.ADDRESS";
    ...
    private String getDirectionsUrl(LatLng origin,LatLng dest){
        ...
        // Key
        String key = "key=" + getString(R.string.app_name);
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String,String>>> > {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            if (lineOptions != null) {
                ...
                Toast.makeText(getApplicationContext(), "Route is not found", Toast.LENGTH_SHORT).show();
        }
    }
}